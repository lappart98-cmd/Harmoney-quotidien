...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        default: {
          bg: "#0d0c08",
          lineActive: { r: 200, g: 255, b: 0, a: 0.9 },
          nodeActive: { r: 200, g: 255, b: 0, a: 1.0 },
          glow: "200,255,0",
          ripple: "200,255,0",
        },
        monochrome: {
          bg: "#0d0c08",
          lineActive: { r: 232, g: 226, b: 208, a: 0.9 },
          nodeActive: { r: 232, g: 226, b: 208, a: 1.0 },
          glow: "232,226,208",
          ripple: "232,226,208",
        },
      }[globalColor ?? "default"];
      ...
      ctx.fillStyle = "rgba(232,226,208,0.04)";
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-screen overflow-hidden bg-[#0d0c08]",
        className,
      )}
    >
